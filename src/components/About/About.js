...
const  About = () => {
    ...
    return (
         <div >
            <Box   flexWrap= 'wrap' style={{   paddingTop:'7%', paddingBottom:'5%', placeContent:'space-between space-around'}} display="flex"   container>
            ...
            <ParticlesBg color="#3f51b5" num={200} type="cobweb" bg={true}/>
